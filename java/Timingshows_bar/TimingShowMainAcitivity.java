...
public class TimingShowMainAcitivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timing_show);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_baseline_time_show);
        ...
        private void setupHyperlink1() {
            TextView linkTextView = findViewById(R.id.TimeShowLink);
