...
public class MediaPhotoMainAcitivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.media_photo_main);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_baseline_photo_library);
    ...
    private void setupHyperlink1() {
        TextView linkTextView = findViewById(R.id.Media_photo1Link);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    private void setupHyperlink2() {
        TextView linkTextView = findViewById(R.id.Media_photo2Link);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }
