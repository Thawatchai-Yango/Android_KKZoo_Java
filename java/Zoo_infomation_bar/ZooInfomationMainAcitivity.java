...
public class ZooInfomationMainAcitivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zoo_information_main);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_baseline_info);
        setupHyperlink1();
        setupHyperlink2();
        setupHyperlink3();
        setupHyperlink4();
    ...
    private void setupHyperlink1() {
        TextView linkTextView = findViewById(R.id.web_zooInfoLink1);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    private void setupHyperlink2() {
        TextView linkTextView = findViewById(R.id.web_zooInfoLink2);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    private void setupHyperlink3() {
        TextView linkTextView = findViewById(R.id.web_zooInfoLink3);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    private void setupHyperlink4() {
        TextView linkTextView = findViewById(R.id.web_zooInfoLink4);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    private void setupHyperlink5() {
        TextView linkTextView = findViewById(R.id.web_zooInfoLink5);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }
