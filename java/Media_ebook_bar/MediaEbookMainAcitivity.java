...
public class MediaEbookMainAcitivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.media_ebook_main);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_baseline_library_books);
        setupHyperlink1();
    }

    private void setupHyperlink1() {
        TextView linkTextView = findViewById(R.id.Media_ebookLink);
