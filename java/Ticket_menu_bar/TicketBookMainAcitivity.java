...
public class TicketBookMainAcitivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ticket_book_main);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_baseline_book_online);
        WebView myWebView = (WebView) findViewById(R.id.web_ticketBook);
        myWebView.loadUrl("https://www.eventpop.me/events/9204/showtime");
    }
