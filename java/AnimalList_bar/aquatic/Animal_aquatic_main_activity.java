package AnimalList_bar.aquatic;
...
public class Animal_aquatic_main_activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ani_aquatic_main);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_aquatic_vector);
        WebView myWebView = (WebView) findViewById(R.id.web_aquatic_main);
        myWebView.loadUrl("http://www.khonkaen.zoothailand.org/animal_more.php?kword=&dept_id=9&cate_id=4&c_id=53");
    }
