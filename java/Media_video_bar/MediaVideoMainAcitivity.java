...
public class MediaVideoMainAcitivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.media_video_main);
        ...
        getSupportActionBar().setIcon(R.drawable.ic_baseline_video_library);
        setupHyperlink1();
        setupHyperlink2();
    }

    private void setupHyperlink1() {
        TextView linkTextView = findViewById(R.id.Media_video1Link);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    private void setupHyperlink2() {
        TextView linkTextView = findViewById(R.id.Media_video2Link);
        linkTextView.setMovementMethod(LinkMovementMethod.getInstance());
    }
